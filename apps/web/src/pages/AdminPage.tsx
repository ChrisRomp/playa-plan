  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Unverified Email Cleanup</h2>
          <p className="text-gray-600 mb-4">
            Review and permanently remove unused participant accounts with stale unverified emails.
          </p>
          <Link
            to={ROUTES.ADMIN_UNVERIFIED_USER_CLEANUP.path}
            className="text-blue-600 hover:text-blue-800 font-medium"
          >
            Review Unused Accounts &rarr;
          </Link>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-600 mb-4">
            Update camp settings, dates, and registration options.
          </p>
          <Link
            to={ROUTES.ADMIN_CONFIG.path}
            className="text-blue-600 hover:text-blue-800 font-medium"
          >
            Edit Configuration →
          </Link>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <Link
            to={ROUTES.ADMIN_CAMPING_OPTIONS.path}
            className="text-blue-600 hover:text-blue-800 font-medium"
          >
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <Link
            to={ROUTES.ADMIN_JOB_CATEGORIES.path}
            className="text-blue-600 hover:text-blue-800 font-medium"
          >
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <Link
            to={ROUTES.ADMIN_MANAGE_REGISTRATIONS.path}
            className="text-blue-600 hover:text-blue-800 font-medium"
          >
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-600 mb-4">
            Review pending applications and approve or decline submissions.
          </p>
          <Link
            to={ROUTES.ADMIN_APPLICATIONS.path}
            className="text-blue-600 hover:text-blue-800 font-medium"
          >
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-600 mb-4">
            Review payments and record completed external transactions.
          </p>
          <Link
            to={ROUTES.ADMIN_PAYMENTS.path}
            className="text-blue-600 hover:text-blue-800 font-medium"
          >
