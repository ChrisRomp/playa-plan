...
import AdminUnverifiedUserCleanupPage from '../pages/AdminUnverifiedUserCleanupPage.tsx';
...
import { ScheduleExceptionsReportPage } from '../pages/ScheduleExceptionsReportPage.tsx';
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route
          path={ROUTES.REPORTS_SCHEDULE_EXCEPTIONS.path}
          element={<ScheduleExceptionsReportPage />}
        />
      ...
      <Route element={<ProtectedRoute requiresAuth={true} allowedRoles={[ROLES.ADMIN]} />}>
        ...
        <Route
          path={ROUTES.ADMIN_UNVERIFIED_USER_CLEANUP.path}
          element={<AdminUnverifiedUserCleanupPage />}
        />
